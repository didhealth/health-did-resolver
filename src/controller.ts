 ...
 */
export class HealthDidController {
  ...
  /**
   * Creates an HealthDidController instance.
   *
   * @param identifier - required - a `did:health` string or a publicKeyHex or an ethereum address
  ...
  constructor(
    ...
    this.did = publicKey ? `did:health:${networkString}${publicKey}` : `did:health:${networkString}${address}`
  }
